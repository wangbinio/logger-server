...
public final class TdengineConstants {
    ...
    public static String buildStableName(String instanceId) {
        return TdengineNaming.buildStableName(instanceId);
    }
    ...
    public static String buildSubTableName(String instanceId, int messageType, int messageCode, int senderId) {
        return TdengineNaming.buildSubTableName(instanceId, messageType, messageCode, senderId);
    }
    ...
    public static String buildTimeControlTableName(String instanceId) {
        return TdengineNaming.buildTimeControlTableName(instanceId);
    }
    ...
    public static String sanitizeIdentifier(String identifier) {
        return TdengineNaming.sanitizeIdentifier(identifier);
    }
}
